import { Action, ActionPanel, Clipboard, Icon, Keyboard, LaunchProps, List, showToast, Toast } from "@raycast/api";
...
export default function Command(props: LaunchProps<{ arguments: Arguments.ExpandUrl }>) {
  ...
  const initialText = props.arguments.url ?? props.fallbackText ?? "";
  ...
  useEffect(() => {
    if (hasSeeded.current || !settings.readClipboard) return;
